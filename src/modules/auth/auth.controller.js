...
export const register = asyncHandler(async (req, res) => {
    ...
    return ApiResponse.send(res, 201, 'Registration successful. Please verify your phone number.', result);
});
...
export const getMe = asyncHandler(async (req, res) => {
    return ApiResponse.send(res, 200, 'Current user', { user: req.user.toSafeJSON() });
});